...
namespace PolyhedralLibrary {
    ...
    void GenerateTriangulatedMesh(
        ...
        triMesh.Cell0DsCoordinates = MatrixXd::Zero(3, duplicatedDimensions[0]);
        ...
        triMesh.Cell2DsVertices.resize(duplicatedDimensions[2]);
        triMesh.Cell2DsEdges.resize(duplicatedDimensions[2]);
